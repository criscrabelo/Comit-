...
**Competência:** todas  
**Executado em:** 2026-08-05T02:12:49.306Z  
...
| Métrica | Valor |
| --- | --- |
| Identificador da execução | `e491a994-dd1a-4b3d-8e76-9aae44fe0579` |
| Quadro | Processos Judiciais — board `5959705266` |
| Início | 2026-08-05T02:12:49.337Z |
| Conclusão | 2026-08-05T02:12:54.738Z |
| Duração | 5.40 s |
...
> **Colunas do mapa não encontradas no quadro:** cliente, cpf_cnpj, contrato, numero. Gravadas como nulas, nunca presumidas.
...
0 de 6 rótulo(s) cobertos pelas regras atuais. 6 rótulo(s) sem cobertura, afetando **273 registro(s)**.

| Rótulo | Ocorrências | Classificação |
| --- | --- | --- |
| ACOMPANHANDO | 150 | ⚠️ **revisão necessária** |
| FINALIZADO | 69 | ⚠️ **revisão necessária** |
| ACORDO | 47 | ⚠️ **revisão necessária** |
| BAIXA DEFINITIVA | 3 | ⚠️ **revisão necessária** |
| RECOMPRA/ACORDO | 3 | ⚠️ **revisão necessária** |
| ARQUIVADO PROVISORIAMENTE | 1 | ⚠️ **revisão necessária** |
...
- **Exemplos (id de origem):** 18171790572, 7024667327, 8456657774, 9356236533, 9365903072

**`FINALIZADO`** — 69 registro(s)

- **Lista sugerida:** `TERMOS_NAO_JUDICIAL`
- **Termo sugerido:** `finalizad`
- **Justificativa:** O rótulo contém "finalizad", que indica etapa anterior ou posterior ao processo. Se a equipe confirmar, incluir "finalizad" em TERMOS_NAO_JUDICIAL.
- **Exemplos (id de origem):** 4497354502, 7756974526, 8914019215, 9267460593, 10598331514

**`ACORDO`** — 47 registro(s)

- **Lista sugerida:** `TERMOS_NAO_JUDICIAL`
- **Termo sugerido:** `acordo`
- **Justificativa:** O rótulo contém "acordo", que indica etapa anterior ou posterior ao processo. Se a equipe confirmar, incluir "acordo" em TERMOS_NAO_JUDICIAL.
- **Exemplos (id de origem):** 12257159068, 9030070002, 9267460671, 18046940632, 10990497119

**`BAIXA DEFINITIVA`** — 3 registro(s)

- **Lista sugerida:** `TERMOS_NAO_JUDICIAL`
- **Termo sugerido:** `baixa`
- **Justificativa:** O rótulo contém "baixa", que indica etapa anterior ou posterior ao processo. Se a equipe confirmar, incluir "baixa" em TERMOS_NAO_JUDICIAL.
- **Exemplos (id de origem):** 6321993107, 3111176334, 6476051916

**`RECOMPRA/ACORDO`** — 3 registro(s)

- **Lista sugerida:** `TERMOS_NAO_JUDICIAL`
- **Termo sugerido:** `acordo`
- **Justificativa:** O rótulo contém "acordo", que indica etapa anterior ou posterior ao processo. Se a equipe confirmar, incluir "acordo" em TERMOS_NAO_JUDICIAL.
- **Exemplos (id de origem):** 7756973009, 9470740338, 6962742400

**`ARQUIVADO PROVISORIAMENTE`** — 1 registro(s)

- **Lista sugerida:** `TERMOS_NAO_JUDICIAL`
- **Termo sugerido:** `arquivad`
- **Justificativa:** O rótulo contém "arquivad", que indica etapa anterior ou posterior ao processo. Se a equipe confirmar, incluir "arquivad" em TERMOS_NAO_JUDICIAL.
- **Exemplos (id de origem):** 6475793594
...
| Métrica | Valor |
| --- | --- |
| Identificador da execução | `ed3f6cb2-fe97-4c83-a415-c0f7c129c535` |
| Quadro | Processos Judiciais — board `5959705266` |
| Início | 2026-08-05T02:12:54.782Z |
| Conclusão | 2026-08-05T02:13:00.763Z |
| Duração | 5.98 s |
| **Quantidade recebida** (lidos da origem) | **273** |
| **Páginas consultadas** | **2** |
| **Último cursor** | `null` — leitura chegou ao fim |
...
| **Com erro** | **0** |
| **Data de referência** | 2026-08-17 |
| **Último dado válido (antes desta execução)** | 2026-08-05T02:12:54.737Z |
| Status | sucesso |
| Contabilidade fecha | sim |
...
| 5 | Registros alterados são atualizados corretamente | ✅ | situação alterada no banco e devolvida pela origem (`ACORDO`); versão 1 → 3; 1 atualizado(s) |
...
[
  {
    ...
    "extraido_em": "2026-08-05T02:13:06.333Z"
  },
  {
    "id_origem": "***6533",
    "numero": "**********0292",
    ...
    "extraido_em": "2026-08-05T02:13:06.336Z"
  },
  {
    "id_origem": "***7057",
    "numero": "**********0292",
    ...
    "posicao": "REQUERENTE",
    "situacao": "ACORDO",
    "situacao_comite": "ACORDO",
    "atuacao": "INTERNO",
    "interno": true,
    "comarca": "JACAREÍ",
    "valor_causa": "***",
    "data_citacao": "2025-04-22",
    "judicializado": false,
    "revisao_necessaria": true,
    "fonte": "monday",
    "versao": 3,
    "data_referencia": "2025-04-22",
    "extraido_em": "2026-08-05T02:13:06.537Z"
  }
]
```
